...
public:
  ...
  /// \brief Constructor to a given value. For example, VictoryPoints{10} sets
  /// the value to 10.
  ...
  /// points.
  struct sort {
    bool operator()(const VictoryPoints& points_1,
                    const VictoryPoints& points_2) const noexcept {
