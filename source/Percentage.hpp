...
public:
  ...
  /// \brief Constructor to a given value. For example, Percentage{0.42} sets the value to 42%.
  ...
  /// \brief Prints to a given number of decimals. For example, Percentage{0.42}.print() returns "42%".
